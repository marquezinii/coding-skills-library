...
- [Iron Law](references/extended-guidance.md#iron-law)
- [Phase 1: Root Cause Investigation](references/extended-guidance.md#phase-1-root-cause-investigation)
- [Prior Learnings](references/extended-guidance.md#prior-learnings)
- [Scope Lock](references/extended-guidance.md#scope-lock)
- [Phase 2: Pattern Analysis](references/extended-guidance.md#phase-2-pattern-analysis)
- [Phase 3: Hypothesis Testing](references/extended-guidance.md#phase-3-hypothesis-testing)
- [Phase 4: Implementation](references/extended-guidance.md#phase-4-implementation)
- [Phase 5: Verification & Report](references/extended-guidance.md#phase-5-verification-report)
