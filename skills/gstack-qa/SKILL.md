...
description: |
  ...
  fix evidence, and a ship-readiness summary. For report-only mode, use /gstack-qa-only. (gstack)
...
- [Test Plan Context](references/extended-guidance.md#test-plan-context)
- [Phases 1-6: QA Baseline](references/extended-guidance.md#phases-1-6-qa-baseline)
