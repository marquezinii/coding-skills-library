...
description: |
  ...
  /gstack-document-release when it finds coverage gaps. Use when asked to "write docs",
...
- [Step 0: Scope & Intent](references/extended-guidance.md#step-0-scope-intent)
- [Step 1: Codebase Archaeology (Research Phase)](references/extended-guidance.md#step-1-codebase-archaeology-research-phase)
- [Step 2: Diataxis Partitioning](references/extended-guidance.md#step-2-diataxis-partitioning)
- [Step 3: Write Reference Documentation First](references/extended-guidance.md#step-3-write-reference-documentation-first)
- [Step 4: Write Explanation Documentation](references/extended-guidance.md#step-4-write-explanation-documentation)
- [Step 5: Write How-To Guides](references/extended-guidance.md#step-5-write-how-to-guides)
- [Verification](references/extended-guidance.md#verification)
- [Troubleshooting](references/extended-guidance.md#troubleshooting)
- [Step 2: [Build the first working piece]](references/extended-guidance.md#step-2-build-the-first-working-piece)
