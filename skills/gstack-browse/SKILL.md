...
- [Core QA Patterns](references/extended-guidance.md#core-qa-patterns)
- [Puppeteer → browse cheatsheet](references/extended-guidance.md#puppeteer-browse-cheatsheet)
- [User Handoff](references/extended-guidance.md#user-handoff)
- [Headed Mode + Proxy + Anti-Bot Sites](references/extended-guidance.md#headed-mode-proxy-anti-bot-sites)
- [Snapshot Flags](references/extended-guidance.md#snapshot-flags)
- [CSS Inspector & Style Modification](references/extended-guidance.md#css-inspector-style-modification)
- [Full Command List](references/extended-guidance.md#full-command-list)
