...
## User-invocable
When the user types `/gstack-health`, run this skill.
...
or misconfigured gbrain doesn't stall the entire /gstack-health dashboard.
...
6. **Trends require history.** On first run, say "First health check -- no trend data yet. Run /gstack-health again after making changes to track progress."
