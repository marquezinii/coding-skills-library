...
- [Step 1: Detect Health Stack](references/extended-guidance.md#step-1-detect-health-stack)
- [Step 2: Run Tools](references/extended-guidance.md#step-2-run-tools)
- [Step 3: Score Each Category](references/extended-guidance.md#step-3-score-each-category)
- [Step 4: Present Dashboard](references/extended-guidance.md#step-4-present-dashboard)
- [Step 5: Persist to Health History](references/extended-guidance.md#step-5-persist-to-health-history)
- [Step 6: Trend Analysis + Recommendations](references/extended-guidance.md#step-6-trend-analysis-recommendations)
