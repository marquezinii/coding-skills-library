...
- [Step 0: Detect what the user wants](references/extended-guidance.md#step-0-detect-what-the-user-wants)
- [Consent + opt-in](references/extended-guidance.md#consent-opt-in)
- [5-Q setup (post-consent, or via Setup gate)](references/extended-guidance.md#5-q-setup-post-consent-or-via-setup-gate)
- [Inspect profile](references/extended-guidance.md#inspect-profile)
- [Review question log](references/extended-guidance.md#review-question-log)
- [Set a preference](references/extended-guidance.md#set-a-preference)
- [Edit declared profile](references/extended-guidance.md#edit-declared-profile)
- [Show gap](references/extended-guidance.md#show-gap)
- [Stats](references/extended-guidance.md#stats)
- [Recent auto-decisions](references/extended-guidance.md#recent-auto-decisions)
