...
`SENTRY_AUTH_TOKEN` is a build-time secret, distinct from the DSN. Follow the current Sentry Next.js documentation linked above when creating the token, wiring it into CI, uploading source maps, or troubleshooting minified traces.
