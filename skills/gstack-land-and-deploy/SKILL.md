...
- [Non-interactive philosophy (like /gstack-ship) — with one critical gate](references/extended-guidance.md#non-interactive-philosophy-like-gstack-ship-with-one-critical-gate)
- [Voice & Tone](references/extended-guidance.md#voice-tone)
- [Step 1: Pre-flight](references/extended-guidance.md#step-1-pre-flight)
- [Step 1.5: First-run dry-run validation](references/extended-guidance.md#step-15-first-run-dry-run-validation)
