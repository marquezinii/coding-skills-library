...
For pulling performance data and managing campaigns, see the the tools or connectors available in the current host.

| Platform | Pull Performance Data | Manage Campaigns | Guide |
|----------|:---------------------:|:----------------:|-------|
| **Google Ads** | `google-ads campaigns list`, `google-ads reports get` | `google-ads campaigns create` | `google-ads.md` (when available) |
| **Meta Ads** | `meta-ads insights get` | `meta-ads campaigns list` | `meta-ads.md` (when available) |
| **LinkedIn Ads** | `linkedin-ads analytics get` | `linkedin-ads campaigns list` | `linkedin-ads.md` (when available) |
| **TikTok Ads** | `tiktok-ads reports get` | `tiktok-ads campaigns list` | `tiktok-ads.md` (when available) |
