...
- [How Tools Work](references/extended-guidance.md#how-tools-work)
- [Interactive CLI Assistant](references/extended-guidance.md#interactive-cli-assistant)
- [MCP Server Integration](references/extended-guidance.md#mcp-server-integration)
- [Custom Agents](references/extended-guidance.md#custom-agents)
- [System Message](references/extended-guidance.md#system-message)
- [External CLI Server](references/extended-guidance.md#external-cli-server)
- [Event Types](references/extended-guidance.md#event-types)
- [Client Configuration](references/extended-guidance.md#client-configuration)
- [Session Configuration](references/extended-guidance.md#session-configuration)
- [Session Persistence](references/extended-guidance.md#session-persistence)
- [Error Handling](references/extended-guidance.md#error-handling)
- [Graceful Shutdown](references/extended-guidance.md#graceful-shutdown)
- [Common Patterns](references/extended-guidance.md#common-patterns)
- [Available Models](references/extended-guidance.md#available-models)
...
- [Status](references/extended-guidance.md#status)
