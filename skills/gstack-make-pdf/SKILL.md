...
[ -z "$P" ] && [ -n "$_ROOT" ] && [ -x "$_ROOT/.agents/skills/gstack/make-pdf/dist/pdf.exe" ] && P="$_ROOT/.agents/skills/gstack/make-pdf/dist/pdf.exe"
...
- [Core patterns](references/extended-guidance.md#core-patterns)
- [Common flags](references/extended-guidance.md#common-flags)
- [When Claude should run it](references/extended-guidance.md#when-claude-should-run-it)
- [Debugging](references/extended-guidance.md#debugging)
- [Output contract](references/extended-guidance.md#output-contract)
