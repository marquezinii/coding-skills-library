...
description: |
  ...
  for this skill?" with data instead of vibes. Separate from /gstack-benchmark, which
...
- [Step 0: Locate the binary](references/extended-guidance.md#step-0-locate-the-binary)
- [Step 1: Choose a prompt](references/extended-guidance.md#step-1-choose-a-prompt)
- [Step 2: Choose providers](references/extended-guidance.md#step-2-choose-providers)
- [Step 3: Decide on judge](references/extended-guidance.md#step-3-decide-on-judge)
- [Step 4: Run the benchmark](references/extended-guidance.md#step-4-run-the-benchmark)
- [Step 5: Interpret results](references/extended-guidance.md#step-5-interpret-results)
- [Step 6: Offer to save results](references/extended-guidance.md#step-6-offer-to-save-results)
- [Important Rules](references/extended-guidance.md#important-rules)
