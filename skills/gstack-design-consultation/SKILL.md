...
- [Phase 0: Pre-checks](references/extended-guidance.md#phase-0-pre-checks)
...
- [Phase 1: Product Context](references/extended-guidance.md#phase-1-product-context)
- [Phase 2: Research (only if user said yes)](references/extended-guidance.md#phase-2-research-only-if-user-said-yes)
- [Phase 3: The Complete Proposal](references/extended-guidance.md#phase-3-the-complete-proposal)
- [Phase 4: Drill-downs (only if user requests adjustments)](references/extended-guidance.md#phase-4-drill-downs-only-if-user-requests-adjustments)
