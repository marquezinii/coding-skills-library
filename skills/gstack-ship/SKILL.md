...
- [Step 1: Pre-flight](references/extended-guidance.md#step-1-pre-flight)
- [Review Readiness Dashboard](references/extended-guidance.md#review-readiness-dashboard)
- [Step 2: Distribution Pipeline Check](references/extended-guidance.md#step-2-distribution-pipeline-check)
- [Step 3: Merge the base branch (BEFORE tests)](references/extended-guidance.md#step-3-merge-the-base-branch-before-tests)
- [Step 4: Test Framework Bootstrap](references/extended-guidance.md#step-4-test-framework-bootstrap)
- [Test Framework Bootstrap](references/extended-guidance.md#test-framework-bootstrap)
- [Step 5: Run tests (on merged code)](references/extended-guidance.md#step-5-run-tests-on-merged-code)
