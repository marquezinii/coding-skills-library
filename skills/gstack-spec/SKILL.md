...
description: |
  ...
  optionally spawns a Claude Code agent in a fresh worktree, and lets /gstack-ship close
...
- [Flag Reference (parse from the user's initial invocation)](references/extended-guidance.md#flag-reference-parse-from-the-users-initial-invocation)
- [Process (STRICT — do not skip or combine phases)](references/extended-guidance.md#process-strict-do-not-skip-or-combine-phases)
- [Plan Mode Safe Operations](references/extended-guidance.md#plan-mode-safe-operations)
- [Skill Invocation During Plan Mode](references/extended-guidance.md#skill-invocation-during-plan-mode)
- [First-run guidance (one-time)](references/extended-guidance.md#first-run-guidance-one-time)
- [AskUserQuestion Format](references/extended-guidance.md#askuserquestion-format)
- [Artifacts Sync (skill start)](references/extended-guidance.md#artifacts-sync-skill-start)
- [Model-Specific Behavioral Patch (gpt-5.4)](references/extended-guidance.md#model-specific-behavioral-patch-gpt-54)
