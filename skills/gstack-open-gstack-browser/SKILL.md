...
- [Step 0: Pre-flight cleanup](references/extended-guidance.md#step-0-pre-flight-cleanup)
- [Step 1: Connect](references/extended-guidance.md#step-1-connect)
- [Step 2: Verify](references/extended-guidance.md#step-2-verify)
- [Step 3: Guide the user to the Side Panel](references/extended-guidance.md#step-3-guide-the-user-to-the-side-panel)
- [Step 4: Demo](references/extended-guidance.md#step-4-demo)
- [Step 5: Sidebar chat](references/extended-guidance.md#step-5-sidebar-chat)
- [Step 6: What's next](references/extended-guidance.md#step-6-whats-next)
