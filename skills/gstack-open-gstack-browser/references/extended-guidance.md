...
# /gstack-open-gstack-browser — Launch GStack Browser
...
> - Run any gstack skill (`/gstack-qa`, `/gstack-design-review`, `/gstack-benchmark`) and watch
...
> - `/gstack-design-review` takes screenshots in the real browser — same pixels you see
