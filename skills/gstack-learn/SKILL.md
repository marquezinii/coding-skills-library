...
- [Show recent (default)](references/extended-guidance.md#show-recent-default)
- [Search](references/extended-guidance.md#search)
- [Prune](references/extended-guidance.md#prune)
- [Export](references/extended-guidance.md#export)
- [Stats](references/extended-guidance.md#stats)
- [Manual add](references/extended-guidance.md#manual-add)
