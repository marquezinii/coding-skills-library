...
- `/gstack-learn` (no arguments) → **Show recent**
- `/gstack-learn search <query>` → **Search**
- `/gstack-learn prune` → **Prune**
- `/gstack-learn export` → **Export**
- `/gstack-learn stats` → **Stats**
- `/gstack-learn add` → **Manual add**
