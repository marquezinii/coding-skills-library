...
description: |
  ...
  iPhone via the same StateServer as /gstack-ios-qa, screenshots every screen,
  ...
  /gstack-plan-design-review for browser. For plan-stage design review (before
  implementation), use /gstack-plan-design-review. For live web visual audits, use
...
- [Connection](references/extended-guidance.md#connection)
- [Dimensions + scoring](references/extended-guidance.md#dimensions-scoring)
- [Loop](references/extended-guidance.md#loop)
- [Output](references/extended-guidance.md#output)
