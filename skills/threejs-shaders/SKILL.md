...
- [Extending Built-in Materials](references/extended-guidance.md#extending-built-in-materials)
- [GLSL Built-in Functions](references/extended-guidance.md#glsl-built-in-functions)
- [Common Material Properties](references/extended-guidance.md#common-material-properties)
- [Shader Includes](references/extended-guidance.md#shader-includes)
- [Instanced Shaders](references/extended-guidance.md#instanced-shaders)
- [Debugging Shaders](references/extended-guidance.md#debugging-shaders)
