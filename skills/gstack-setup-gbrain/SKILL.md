...
- [User-invocable](references/extended-guidance.md#user-invocable)
- [Step 1: Detect current state](references/extended-guidance.md#step-1-detect-current-state)
- [Step 1.5: Broken-local-engine remediation (plan D4)](references/extended-guidance.md#step-15-broken-local-engine-remediation-plan-d4)
- [Step 2: Pick a path (AskUserQuestion)](references/extended-guidance.md#step-2-pick-a-path-askuserquestion)
- [Step 3: Install gbrain CLI (if missing)](references/extended-guidance.md#step-3-install-gbrain-cli-if-missing)
- [Step 4: Initialize the brain](references/extended-guidance.md#step-4-initialize-the-brain)
- [Step 5: Verify gbrain doctor](references/extended-guidance.md#step-5-verify-gbrain-doctor)
- [Step 5a: Register gbrain as Claude Code MCP (D18)](references/extended-guidance.md#step-5a-register-gbrain-as-claude-code-mcp-d18)
- [Step 6: Per-remote policy (D3 triad, gated repo-import)](references/extended-guidance.md#step-6-per-remote-policy-d3-triad-gated-repo-import)
- [Step 7: Offer artifacts sync + wire it into gbrain](references/extended-guidance.md#step-7-offer-artifacts-sync-wire-it-into-gbrain)
