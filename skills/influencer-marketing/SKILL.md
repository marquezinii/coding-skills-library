...
For implementation, see the the tools or connectors available in the current host.

| Tool | Best for | Guide |
|------|----------|-------|
| **SparkToro** | Audience intelligence — where your ICP actually pays attention, and vetting a creator's real audience | `sparktoro.md` (when available) |
