...
description: |
  ...
  Use before /gstack-plan-ceo-review or /gstack-plan-eng-review. (gstack)
---
...
- [Phase 1: Context Gathering](references/extended-guidance.md#phase-1-context-gathering)
- [Prior Learnings](references/extended-guidance.md#prior-learnings)
- [Phase 2A: Startup Mode — YC Product Diagnostic](references/extended-guidance.md#phase-2a-startup-mode-yc-product-diagnostic)
- [Phase 2B: Builder Mode — Design Partner](references/extended-guidance.md#phase-2b-builder-mode-design-partner)
- [Phase 2.5: Related Design Discovery](references/extended-guidance.md#phase-25-related-design-discovery)
- [Phase 2.75: Landscape Awareness](references/extended-guidance.md#phase-275-landscape-awareness)
