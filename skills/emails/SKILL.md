...
For implementation, see the the tools or connectors available in the current host. Key email tools:

| Tool | Best For | MCP | Guide |
|------|----------|:---:|-------|
| **Customer.io** | Behavior-based automation | - | `customer-io.md` (when available) |
| **Mailchimp** | SMB email marketing | ✓ | `mailchimp.md` (when available) |
| **Nitrosend** | AI-native email (sequences via prompts) | ✓ | `nitrosend.md` (when available) |
| **Resend** | Developer-friendly transactional | ✓ | `resend.md` (when available) |
| **SendGrid** | Transactional email at scale | - | `sendgrid.md` (when available) |
| **Kit** | Creator/newsletter focused | - | `kit.md` (when available) |
