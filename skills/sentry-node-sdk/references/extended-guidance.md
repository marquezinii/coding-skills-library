...
> **Use the [official Sentry NestJS guide](https://docs.sentry.io/platforms/javascript/guides/nestjs/) instead.**
...
| NestJS | → Use the [official Sentry NestJS guide](https://docs.sentry.io/platforms/javascript/guides/nestjs/) | Dedicated integration | — |
...
Upload needs a `SENTRY_AUTH_TOKEN` as a build-time secret. Follow the current Sentry Node.js documentation linked above for token scope, source-map upload, and CI wiring.
...
|----------|-------------|-----|
| NestJS (`@nestjs/core` in `package.json`) | [Official Sentry NestJS guide](https://docs.sentry.io/platforms/javascript/guides/nestjs/) | Uses `@sentry/nestjs` with NestJS-native decorators, filters, and GraphQL support |
...
| NestJS: errors not captured | Wrong SDK or missing filter | Follow the [official Sentry NestJS guide](https://docs.sentry.io/platforms/javascript/guides/nestjs/) — NestJS needs `@sentry/nestjs`, not `@sentry/node` |
