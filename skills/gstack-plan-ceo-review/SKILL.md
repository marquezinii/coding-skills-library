...
- [Philosophy](references/extended-guidance.md#philosophy)
- [Prime Directives](references/extended-guidance.md#prime-directives)
- [Engineering Preferences (use these to guide every recommendation)](references/extended-guidance.md#engineering-preferences-use-these-to-guide-every-recommendation)
- [Cognitive Patterns — How Great CEOs Think](references/extended-guidance.md#cognitive-patterns-how-great-ceos-think)
- [Priority Hierarchy Under Context Pressure](references/extended-guidance.md#priority-hierarchy-under-context-pressure)
- [PRE-REVIEW SYSTEM AUDIT (before Step 0)](references/extended-guidance.md#pre-review-system-audit-before-step-0)
