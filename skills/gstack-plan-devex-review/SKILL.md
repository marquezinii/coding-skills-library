...
- [DX First Principles](references/extended-guidance.md#dx-first-principles)
- [The Seven DX Characteristics](references/extended-guidance.md#the-seven-dx-characteristics)
- [Cognitive Patterns — How Great DX Leaders Think](references/extended-guidance.md#cognitive-patterns-how-great-dx-leaders-think)
- [DX Scoring Rubric (0-10 calibration)](references/extended-guidance.md#dx-scoring-rubric-0-10-calibration)
- [TTHW Benchmarks (Time to Hello World)](references/extended-guidance.md#tthw-benchmarks-time-to-hello-world)
- [Hall of Fame Reference](references/extended-guidance.md#hall-of-fame-reference)
