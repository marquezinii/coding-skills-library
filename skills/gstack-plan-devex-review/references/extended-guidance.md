...
"This plan doesn't appear to have developer-facing surfaces. /gstack-plan-devex-review
reviews plans for APIs, CLIs, SDKs, libraries, platforms, and docs. Consider
/gstack-plan-eng-review or /gstack-plan-design-review instead." Exit gracefully.
...
- **Boomerang readiness**: Will /gstack-devex-review be able to measure reality vs. plan?
...
**Recommend /gstack-plan-eng-review if eng review is not skipped globally** — DX issues often
...
**Suggest /gstack-plan-design-review if user-facing UI exists** — DX review focuses on
developer-facing surfaces; design review covers end-user-facing UI.

**Recommend /gstack-devex-review after implementation** — the boomerang. Plan said TTHW would
be [target from 0C]. Did reality match? Run /gstack-devex-review on the live product to find
...
- **B)** Run /gstack-plan-design-review (only if UI scope detected)
- **C)** Ready to implement, run /gstack-devex-review after shipping
