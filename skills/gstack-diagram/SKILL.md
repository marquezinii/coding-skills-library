...
- [Step 1 — Author the diagram](references/extended-guidance.md#step-1-author-the-diagram)
- [Step 2 — Stage the render bundle (once per session)](references/extended-guidance.md#step-2-stage-the-render-bundle-once-per-session)
- [Step 3 — Render the triplet](references/extended-guidance.md#step-3-render-the-triplet)
- [Step 4 — Show and deliver](references/extended-guidance.md#step-4-show-and-deliver)
- [Rules](references/extended-guidance.md#rules)
- [Completion status](references/extended-guidance.md#completion-status)
