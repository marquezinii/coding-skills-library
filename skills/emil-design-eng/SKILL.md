...
- [CSS Transform Mastery](references/extended-guidance.md#css-transform-mastery)
- [clip-path for Animation](references/extended-guidance.md#clip-path-for-animation)
- [Gesture and Drag Interactions](references/extended-guidance.md#gesture-and-drag-interactions)
- [Performance Rules](references/extended-guidance.md#performance-rules)
- [Accessibility](references/extended-guidance.md#accessibility)
- [The Sonner Principles (Building Loved Components)](references/extended-guidance.md#the-sonner-principles-building-loved-components)
- [Stagger Animations](references/extended-guidance.md#stagger-animations)
- [Debugging Animations](references/extended-guidance.md#debugging-animations)
- [Review Checklist](references/extended-guidance.md#review-checklist)
