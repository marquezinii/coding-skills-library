...
fewer variants and benefits from sequential control. Note: /gstack-design-shotgun uses
...
**Recommend design exploration skills when appropriate** — /gstack-design-shotgun and /gstack-design-html
...
from exploring new directions, recommend /gstack-design-shotgun. If approved mockups exist and
need to be turned into working HTML, recommend /gstack-design-html.
...
- **C)** Run /gstack-design-shotgun — explore visual design variants for issues found
- **D)** Run /gstack-design-html — generate Pretext-native HTML from approved mockups
