...
- [Step 0: Session Detection](references/extended-guidance.md#step-0-session-detection)
- [Step 1: Context Gathering](references/extended-guidance.md#step-1-context-gathering)
- [Step 2: Taste Memory](references/extended-guidance.md#step-2-taste-memory)
- [Step 3: Generate Variants](references/extended-guidance.md#step-3-generate-variants)
- [Step 4: Comparison Board + Feedback Loop](references/extended-guidance.md#step-4-comparison-board-feedback-loop)
- [Step 5: Feedback Confirmation](references/extended-guidance.md#step-5-feedback-confirmation)
- [Step 6: Save & Next Steps](references/extended-guidance.md#step-6-save-next-steps)
