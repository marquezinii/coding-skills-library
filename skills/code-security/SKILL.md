...
name: code-security
description: >-
  Apply language-agnostic secure-coding rules to security-sensitive code involving untrusted input, authentication, file access, database queries, network requests, cryptography, or infrastructure configuration. Use for explicit secure-coding requests and security-focused code review. Do not trigger for routine implementation or general code review without a meaningful security surface.
---
