...
- [Wrapping component](references/extended-guidance.md#wrapping-component)
- [Running a slideshow standalone (interim)](references/extended-guidance.md#running-a-slideshow-standalone-interim)
- [Handoff](references/extended-guidance.md#handoff)
- [Validation](references/extended-guidance.md#validation)
