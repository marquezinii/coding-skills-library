...
description: |
  ...
  WIP work likely to ship soon, and what slot /gstack-ship would pick next. No
...
# /gstack-landing-report — Version Queue Dashboard
...
- [Why this skill exists](references/extended-guidance.md#why-this-skill-exists)
- [Step 1: Detect platform and base branch](references/extended-guidance.md#step-1-detect-platform-and-base-branch)
- [Step 2: Read current state](references/extended-guidance.md#step-2-read-current-state)
- [Step 3: Query the queue](references/extended-guidance.md#step-3-query-the-queue)
- [Step 4: Render the dashboard](references/extended-guidance.md#step-4-render-the-dashboard)
- [Step 5: Suggest next action](references/extended-guidance.md#step-5-suggest-next-action)
- [Plan Mode](references/extended-guidance.md#plan-mode)
