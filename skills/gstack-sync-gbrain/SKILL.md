...
- [Step 1: State probe](references/extended-guidance.md#step-1-state-probe)
- [Step 1.5: Local engine pre-flight (plan D12)](references/extended-guidance.md#step-15-local-engine-pre-flight-plan-d12)
- [Step 2: Run the orchestrator](references/extended-guidance.md#step-2-run-the-orchestrator)
- [Step 3: Code-index health check](references/extended-guidance.md#step-3-code-index-health-check)
- [Step 3.5: Call-graph health check (offer `--dream`)](references/extended-guidance.md#step-35-call-graph-health-check-offer-dream)
- [Step 4: Refresh `## GBrain Search Guidance` block in CLAUDE.md](references/extended-guidance.md#step-4-refresh-gbrain-search-guidance-block-in-claudemd)
- [Step 5: Verdict block (idempotent doctor output)](references/extended-guidance.md#step-5-verdict-block-idempotent-doctor-output)
- [Concurrency note](references/extended-guidance.md#concurrency-note)
- [Cross-machine note](references/extended-guidance.md#cross-machine-note)
