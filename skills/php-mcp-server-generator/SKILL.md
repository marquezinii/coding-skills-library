...
- [Tool Patterns](references/extended-guidance.md#tool-patterns)
- [Resource Patterns](references/extended-guidance.md#resource-patterns)
- [Running the Server](references/extended-guidance.md#running-the-server)
- [Claude Desktop Configuration](references/extended-guidance.md#claude-desktop-configuration)
