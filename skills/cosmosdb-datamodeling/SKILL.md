...
- [Important Azure Cosmos DB NoSQL Context](references/extended-guidance.md#important-azure-cosmos-db-nosql-context)
- [Core Design Philosophy](references/extended-guidance.md#core-design-philosophy)
- [Design Patterns](references/extended-guidance.md#design-patterns)
