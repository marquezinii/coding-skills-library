...
# /gstack-pair-agent — Share Your Browser With Another AI Agent
...
4. Come back here and run `/gstack-pair-agent` again."
...
**"Token expired"** — The 24-hour session expired. Run `/gstack-pair-agent` again to
...
to `$HOME/.agents/skills/gstack/browse-remote.json`.
