...
- [How it works](references/extended-guidance.md#how-it-works)
...
- [Step 1: Check prerequisites](references/extended-guidance.md#step-1-check-prerequisites)
- [Step 2: Ask what they want](references/extended-guidance.md#step-2-ask-what-they-want)
- [Step 3: Local or remote?](references/extended-guidance.md#step-3-local-or-remote)
- [Step 4: Execute pairing](references/extended-guidance.md#step-4-execute-pairing)
- [Step 5: Verify connection](references/extended-guidance.md#step-5-verify-connection)
- [What the remote agent can do](references/extended-guidance.md#what-the-remote-agent-can-do)
