...
For partner sales enablement, see the the tools or connectors available in the current host:

| Tool | What It Does | Guide |
|------|-------------|-------|
| **Introw** | Partner engagement tracking, deal registration, mutual action plans | `introw.md` (when available) |
