...
- [Step 1 — Determine intent](references/extended-guidance.md#step-1-determine-intent)
- [Step 2 — Refuse mutating intents](references/extended-guidance.md#step-2-refuse-mutating-intents)
- [Step 3 — Match phase](references/extended-guidance.md#step-3-match-phase)
- [Step 4 — Prototype phase](references/extended-guidance.md#step-4-prototype-phase)
- [Step 5 — Skillify nudge](references/extended-guidance.md#step-5-skillify-nudge)
- [When the prototype fails](references/extended-guidance.md#when-the-prototype-fails)
- [What this skill does NOT do](references/extended-guidance.md#what-this-skill-does-not-do)
- [Output discipline](references/extended-guidance.md#output-discipline)
