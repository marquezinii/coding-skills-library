...
For implementation, see the the tools or connectors available in the current host. Key tools for referral programs:

| Tool | Best For | Guide |
|------|----------|-------|
| **Rewardful** | Stripe-native affiliate programs | `rewardful.md` (when available) |
| **Tolt** | SaaS affiliate programs | `tolt.md` (when available) |
| **Mention Me** | Enterprise referral programs | `mention-me.md` (when available) |
| **Dub.co** | Link tracking and attribution | `dub-co.md` (when available) |
| **Stripe** | Payment processing (for commission tracking) | `stripe.md` (when available) |
| **Introw** | Channel partner programs with tiers, deal registration, QBRs | `introw.md` (when available) |
| **PartnerStack** | Enterprise partner and affiliate programs | `partnerstack.md` (when available) |
