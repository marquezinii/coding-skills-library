...
- [Step 0: Check Claude CLI](references/extended-guidance.md#step-0-check-claude-cli)
- [Safety Boundary](references/extended-guidance.md#safety-boundary)
- [Step 1: Detect Mode](references/extended-guidance.md#step-1-detect-mode)
- [Shared Helpers](references/extended-guidance.md#shared-helpers)
- [Step 2A: Review Mode](references/extended-guidance.md#step-2a-review-mode)
- [Step 2B: Challenge Mode](references/extended-guidance.md#step-2b-challenge-mode)
- [Step 2C: Consult Mode](references/extended-guidance.md#step-2c-consult-mode)
