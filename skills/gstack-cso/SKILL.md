...
- [Mode Resolution](references/extended-guidance.md#mode-resolution)
- [Important: Use the Grep tool for all code searches](references/extended-guidance.md#important-use-the-grep-tool-for-all-code-searches)
- [Instructions](references/extended-guidance.md#instructions)
- [Prior Learnings](references/extended-guidance.md#prior-learnings)
- [Confidence Calibration](references/extended-guidance.md#confidence-calibration)
...
- [Disclaimer](references/extended-guidance.md#disclaimer)
