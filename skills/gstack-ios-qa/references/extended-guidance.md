...
|---|---|---|
| `curl: connection refused` to daemon | daemon crashed | Re-run `/gstack-ios-qa`; spawn-race lock will fail closed |
...
Use `/gstack-ios-clean` to remove the DebugBridge SPM dependency and all `#if DEBUG`
