...
- [Architecture](references/extended-guidance.md#architecture)
- [Prerequisites](references/extended-guidance.md#prerequisites)
- [Phase 0: Session warm-start (optional)](references/extended-guidance.md#phase-0-session-warm-start-optional)
- [Phase 1: Read source, plan codegen](references/extended-guidance.md#phase-1-read-source-plan-codegen)
- [Phase 2: Bootstrap the device bridge](references/extended-guidance.md#phase-2-bootstrap-the-device-bridge)
- [Phase 3: Vision-driven agent loop](references/extended-guidance.md#phase-3-vision-driven-agent-loop)
- [Modes](references/extended-guidance.md#modes)
- [Demo mode](references/extended-guidance.md#demo-mode)
