...
- `$HOME/.agents/skills/gstack-plan-ceo-review/SKILL.md`
- `$HOME/.agents/skills/gstack-plan-design-review/SKILL.md` (only if UI scope detected)
- `$HOME/.agents/skills/gstack-plan-eng-review/SKILL.md`
- `$HOME/.agents/skills/gstack-plan-devex-review/SKILL.md` (only if DX scope detected)
...
`[codex-unavailable]` in the degradation matrix. /gstack-autoplan completes with
