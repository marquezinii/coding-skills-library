...
- [The 6 Decision Principles](references/extended-guidance.md#the-6-decision-principles)
- [Decision Classification](references/extended-guidance.md#decision-classification)
- [Sequential Execution — MANDATORY](references/extended-guidance.md#sequential-execution-mandatory)
- [What "Auto-Decide" Means](references/extended-guidance.md#what-auto-decide-means)
- [Filesystem Boundary — Codex Prompts](references/extended-guidance.md#filesystem-boundary-codex-prompts)
- [Phase 0: Intake + Restore Point](references/extended-guidance.md#phase-0-intake-restore-point)
