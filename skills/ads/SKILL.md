...
For implementation, see the the tools or connectors available in the current host. Key advertising platforms:

| Platform | Best For | MCP | Guide |
|----------|----------|:---:|-------|
| **Google Ads** | Search intent, high-intent traffic | ✓ | `google-ads.md` (when available) |
| **Meta Ads** | Demand gen, visual products, B2C | - | `meta-ads.md` (when available) |
| **LinkedIn Ads** | B2B, job title targeting | - | `linkedin-ads.md` (when available) |
| **TikTok Ads** | Younger demographics, video | - | `tiktok-ads.md` (when available) |

For tracking setup, see [references/conversion-tracking.md](references/conversion-tracking.md), `ga4.md` (when available), `segment.md` (when available)
