...
description: |
  ...
  app-side hooks installed by /gstack-ios-qa. This is a convenience wrapper —
...
- [What it removes](references/extended-guidance.md#what-it-removes)
- [What it does NOT touch](references/extended-guidance.md#what-it-does-not-touch)
- [Phase 1: Inventory](references/extended-guidance.md#phase-1-inventory)
- [Phase 2: Remove](references/extended-guidance.md#phase-2-remove)
- [Phase 3: Verify](references/extended-guidance.md#phase-3-verify)
- [Reversibility](references/extended-guidance.md#reversibility)
