...
```bash
source <($HOME/.agents/skills/gstack/bin/gstack-diff-scope <base> 2>/dev/null)
```
...
- **[LOW]** — Requires understanding visual intent. Present as: "Possible issue — verify visually or run /gstack-design-review."
...
**LOW confidence items** → present as "Possible: [description]. Verify visually or run /gstack-design-review." Never AUTO-FIX.
...
- [file:line] Possible issue — verify with /gstack-design-review
```
