...
Shared reference for the canonical TODOS.md format. Referenced by `/gstack-ship` (Step 5.5) and `/gstack-plan-ceo-review` (TODOS.md updates section) to ensure consistent TODO item structure.
