...
description: |
  Restore working context saved earlier by /gstack-context-save. Loads the most recent
  ...
  "pick up where I left off". Pair with /gstack-context-save.
...
- [Detect command](references/extended-guidance.md#detect-command)
- [Restore flow](references/extended-guidance.md#restore-flow)
- [If no saved contexts exist](references/extended-guidance.md#if-no-saved-contexts-exist)
