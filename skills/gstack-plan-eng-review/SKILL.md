...
- [Scope gate (FIRST — overrides everything below). This is a hard STOP.](references/extended-guidance.md#scope-gate-first-overrides-everything-below-this-is-a-hard-stop)
- [Priority hierarchy](references/extended-guidance.md#priority-hierarchy)
- [My engineering preferences (use these to guide your recommendations):](references/extended-guidance.md#my-engineering-preferences-use-these-to-guide-your-recommendations)
- [Cognitive Patterns — How Great Eng Managers Think](references/extended-guidance.md#cognitive-patterns-how-great-eng-managers-think)
- [Documentation and diagrams:](references/extended-guidance.md#documentation-and-diagrams)
- [Brain Context (preflight)](references/extended-guidance.md#brain-context-preflight)
- [BEFORE YOU START:](references/extended-guidance.md#before-you-start)
- [Prerequisite Skill Offer](references/extended-guidance.md#prerequisite-skill-offer)
