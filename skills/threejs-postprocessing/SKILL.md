...
- [Custom ShaderPass](references/extended-guidance.md#custom-shaderpass)
- [Combining Multiple Effects](references/extended-guidance.md#combining-multiple-effects)
- [Render to Texture](references/extended-guidance.md#render-to-texture)
- [Multi-Pass Rendering](references/extended-guidance.md#multi-pass-rendering)
- [WebGPU Post-Processing (Three.js r150+)](references/extended-guidance.md#webgpu-post-processing-threejs-r150)
- [Performance Tips](references/extended-guidance.md#performance-tips)
- [Handle Resize](references/extended-guidance.md#handle-resize)
- [See Also](references/extended-guidance.md#see-also)
