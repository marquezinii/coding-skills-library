...
- [Extract Method Refactoring](references/extended-guidance.md#extract-method-refactoring)
- [Introducing Type Safety](references/extended-guidance.md#introducing-type-safety)
- [Design Patterns for Refactoring](references/extended-guidance.md#design-patterns-for-refactoring)
- [Refactoring Steps](references/extended-guidance.md#refactoring-steps)
- [Refactoring Checklist](references/extended-guidance.md#refactoring-checklist)
- [Common Refactoring Operations](references/extended-guidance.md#common-refactoring-operations)
- [Additional worked recipes](references/recipes.md)
