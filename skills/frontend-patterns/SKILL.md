...
- [Form Handling Patterns](references/extended-guidance.md#form-handling-patterns)
- [Error Boundary Pattern](references/extended-guidance.md#error-boundary-pattern)
- [Animation Patterns](references/extended-guidance.md#animation-patterns)
- [Accessibility Patterns](references/extended-guidance.md#accessibility-patterns)
