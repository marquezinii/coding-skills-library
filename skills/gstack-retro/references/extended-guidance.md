...
```bash
DISCOVER_BIN=""
[ -x $GSTACK_ROOT/bin/gstack-global-discover.exe ] && DISCOVER_BIN=$GSTACK_ROOT/bin/gstack-global-discover.exe
[ -z "$DISCOVER_BIN" ] && [ -x .agents/skills/gstack/bin/gstack-global-discover.exe ] && DISCOVER_BIN=.agents/skills/gstack/bin/gstack-global-discover.exe
