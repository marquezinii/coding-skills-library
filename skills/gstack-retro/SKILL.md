...
- [Arguments](references/extended-guidance.md#arguments)
- [Instructions](references/extended-guidance.md#instructions)
- [Prior Learnings](references/extended-guidance.md#prior-learnings)
- [Capture Learnings](references/extended-guidance.md#capture-learnings)
- [Engineering Retro: [date range]](references/extended-guidance.md#engineering-retro-date-range)
- [Global Retrospective Mode](references/extended-guidance.md#global-retrospective-mode)
- [🚀 Your Week: [user name] — [date range]](references/extended-guidance.md#your-week-user-name-date-range)
- [Global Engineering Retro: [date range]](references/extended-guidance.md#global-engineering-retro-date-range)
