...
- [Async/Promise Loading](references/extended-guidance.md#asyncpromise-loading)
- [Caching](references/extended-guidance.md#caching)
- [Loading from Different Sources](references/extended-guidance.md#loading-from-different-sources)
