...
- [Step 1: Check branch](references/extended-guidance.md#step-1-check-branch)
- [Step 1.5: Scope Drift Detection](references/extended-guidance.md#step-15-scope-drift-detection)
- [Step 2: Read the checklist](references/extended-guidance.md#step-2-read-the-checklist)
- [Step 2.5: Check for Greptile review comments](references/extended-guidance.md#step-25-check-for-greptile-review-comments)
- [Step 3: Get the diff](references/extended-guidance.md#step-3-get-the-diff)
- [Step 3.4: Workspace-aware queue status (advisory)](references/extended-guidance.md#step-34-workspace-aware-queue-status-advisory)
- [Step 3.5: Slop scan (advisory)](references/extended-guidance.md#step-35-slop-scan-advisory)
