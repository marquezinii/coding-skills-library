...
- [Step 0: Detect platform and base branch](references/extended-guidance.md#step-0-detect-platform-and-base-branch)
- [Step 1: Pre-flight & Diff Analysis](references/extended-guidance.md#step-1-pre-flight-diff-analysis)
- [Step 1.5: Coverage Map (Blast-Radius Analysis)](references/extended-guidance.md#step-15-coverage-map-blast-radius-analysis)
- [Step 2: Per-File Documentation Audit](references/extended-guidance.md#step-2-per-file-documentation-audit)
- [Step 3: Apply Auto-Updates](references/extended-guidance.md#step-3-apply-auto-updates)
- [Step 4: Ask About Risky/Questionable Changes](references/extended-guidance.md#step-4-ask-about-riskyquestionable-changes)
- [Step 5: CHANGELOG Voice Polish](references/extended-guidance.md#step-5-changelog-voice-polish)
- [Step 6: Cross-Doc Consistency & Discoverability Check](references/extended-guidance.md#step-6-cross-doc-consistency-discoverability-check)
- [Step 7: TODOS.md Cleanup](references/extended-guidance.md#step-7-todosmd-cleanup)
- [Step 8: VERSION Bump Question](references/extended-guidance.md#step-8-version-bump-question)
