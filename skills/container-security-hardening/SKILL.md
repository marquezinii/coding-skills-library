...
- [Layer 2: Image Scanning](references/extended-guidance.md#layer-2-image-scanning)
- [Layer 3: Runtime Security](references/extended-guidance.md#layer-3-runtime-security)
- [Layer 4: Supply Chain Security](references/extended-guidance.md#layer-4-supply-chain-security)
- [Layer 5: Kubernetes Pod Security](references/extended-guidance.md#layer-5-kubernetes-pod-security)
- [Common Pitfalls & Fixes](references/extended-guidance.md#common-pitfalls-fixes)
