...
description: |
  Codify the most recent successful /gstack-scrape flow into a permanent
  browser-skill on disk. Future /gstack-scrape calls with the same intent run
...
- [Iron contract — never write a half-broken skill to disk](references/extended-guidance.md#iron-contract-never-write-a-half-broken-skill-to-disk)
- [Step 1 — Provenance guard (D1)](references/extended-guidance.md#step-1-provenance-guard-d1)
- [Step 2 — Propose name + triggers](references/extended-guidance.md#step-2-propose-name-triggers)
- [Step 3 — Synthesize `script.ts` (D2)](references/extended-guidance.md#step-3-synthesize-scriptts-d2)
- [Step 4 — Capture the fixture](references/extended-guidance.md#step-4-capture-the-fixture)
- [Step 5 — Write `script.test.ts`](references/extended-guidance.md#step-5-write-scripttestts)
- [Step 6 — Resolve the canonical SDK path + read it](references/extended-guidance.md#step-6-resolve-the-canonical-sdk-path-read-it)
- [Step 7 — Stage the skill (D3 atomic write)](references/extended-guidance.md#step-7-stage-the-skill-d3-atomic-write)
