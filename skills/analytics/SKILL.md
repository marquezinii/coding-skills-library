...
For implementation, see the the tools or connectors available in the current host. Key analytics tools:

| Tool | Best For | MCP | Guide |
|------|----------|:---:|-------|
| **GA4** | Web analytics, Google ecosystem | ✓ | `ga4.md` (when available) |
| **Mixpanel** | Product analytics, event tracking | - | `mixpanel.md` (when available) |
| **Amplitude** | Product analytics, cohort analysis | - | `amplitude.md` (when available) |
| **PostHog** | Open-source analytics, session replay | - | `posthog.md` (when available) |
| **Segment** | Customer data platform, routing | - | `segment.md` (when available) |
