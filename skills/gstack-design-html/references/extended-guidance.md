...
# /gstack-design-html: Pretext-Native HTML Engine
...
D=""
[ -n "$_ROOT" ] && [ -x "$_ROOT/.agents/skills/gstack/design/dist/design.exe" ] && D="$_ROOT/.agents/skills/gstack/design/dist/design.exe"
...
B=""
[ -n "$_ROOT" ] && [ -x "$_ROOT/.agents/skills/gstack/browse/dist/browse.exe" ] && B="$_ROOT/.agents/skills/gstack/browse/dist/browse.exe"
...
Use AskUserQuestion:
> Found [CEO plan from /gstack-plan-ceo-review | design review variants from /gstack-plan-design-review | both]
> but no approved design mockup.
> A) Run /gstack-design-shotgun — explore design variants based on the existing plan context
> B) Skip mockups — I'll design the HTML directly from the plan context
> C) I have a PNG — let me provide the path

If A: tell the user to run /gstack-design-shotgun, then come back to /gstack-design-html.
...
> A) Run /gstack-plan-ceo-review first — think through the product strategy before designing
> B) Run /gstack-plan-design-review first — design review with visual mockups
> C) Run /gstack-design-shotgun — jump straight to visual design exploration
> D) Just describe it — tell me what you want and I'll design the HTML live

If A, B, or C: tell the user to run that skill, then come back to /gstack-design-html.
...
> and create a DESIGN.md for your project. This means future /gstack-design-shotgun and
> /gstack-design-html runs will be style-consistent automatically.
...
- **One page per invocation.** For multi-page designs, run /gstack-design-html once per page.
