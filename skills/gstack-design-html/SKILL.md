...
description: |
  ...
  Works with approved mockups from /gstack-design-shotgun, CEO plans from /gstack-plan-ceo-review,
  design review context from /gstack-plan-design-review, or from scratch with a user
...
- [Step 0: Input Detection](references/extended-guidance.md#step-0-input-detection)
- [Step 1: Design Analysis](references/extended-guidance.md#step-1-design-analysis)
- [Step 2: Smart Pretext API Routing](references/extended-guidance.md#step-2-smart-pretext-api-routing)
- [Step 2.5: Framework Detection](references/extended-guidance.md#step-25-framework-detection)
- [Step 3: Generate Pretext-Native HTML](references/extended-guidance.md#step-3-generate-pretext-native-html)
- [Step 3.5: Live Reload Server](references/extended-guidance.md#step-35-live-reload-server)
- [Step 4: Preview + Refinement Loop](references/extended-guidance.md#step-4-preview-refinement-loop)
