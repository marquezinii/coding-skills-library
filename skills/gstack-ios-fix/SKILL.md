...
name: gstack-ios-fix
description: |
  Autonomous iOS bug fixer. Takes a bug found by /gstack-ios-qa, reads the source,
  ...
  Use when /gstack-ios-qa reports a bug and you want it fixed automatically, or
...
- [Phase 1: Reproduce the bug](references/extended-guidance.md#phase-1-reproduce-the-bug)
- [Phase 2: Locate root cause](references/extended-guidance.md#phase-2-locate-root-cause)
- [Phase 3: Apply fix](references/extended-guidance.md#phase-3-apply-fix)
- [Phase 4: Verify](references/extended-guidance.md#phase-4-verify)
- [Phase 5: Add regression test](references/extended-guidance.md#phase-5-add-regression-test)
- [Failure modes](references/extended-guidance.md#failure-modes)
